...
infiniteNaturals = [0..] -- Define the infinite list
...
findFirstMultiple k = head (filter (\x -> x `mod` k == 0) infiniteNaturals)  -- Complete this function
...
nthFib :: Int -> Int
nthFib n = fibs !! n  -- Complete this function
