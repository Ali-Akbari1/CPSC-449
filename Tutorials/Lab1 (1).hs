...
exOr :: Bool -> Bool -> Bool
exOr a b = (a || b) && not(a && b)          -- enter your code here
...
triangleArea base height = base * height * 0.5       -- enter your code here

-- Implement a function that determines if three numbers can form a right triangle.
isPythagoreanTriple :: Int -> Int -> Int -> Bool
isPythagoreanTriple a b c = (a^2) + (b^2) == (c^2)           -- enter your code here   
